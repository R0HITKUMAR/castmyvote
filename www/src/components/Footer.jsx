      ...
      <div className="bg-wrapper">
        <div className="container">
          <div className="row justify-content-between">
            <div className="col-md-3 col-12 footer-intro mb-40">
            ...
            <div className="col-md-3 col-7 mb-30">
              <h5 className="footer-title fw-normal">Documentation</h5>
              <ul className="footer-nav-link style-none">
                <li>
                  <a
            ...
            <div className="col-md-3 col-12 mb-30 form-widget">
